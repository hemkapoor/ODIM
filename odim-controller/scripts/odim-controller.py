...
def update_helm_charts(config_map_name):
	...
	optionHelmChartInfo = {
		...
		"composition-service": "odim_svc_helmcharts",
	...
	operationHelmChartInfo={
		...
		"composition-service": "upgrade-config",
