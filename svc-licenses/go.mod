...
require (
	...
	github.com/ODIM-Project/ODIM/lib-rest-client v0.0.0-00010101000000-000000000000
...
require (
	...
	k8s.io/apimachinery v0.21.10 // indirect
	k8s.io/client-go v0.21.10 // indirect
