...
type Links struct {
	...
	ManagerForChassis   []dmtf.Link `json:"ManagerForChassis"`
	ManagerForServers   []dmtf.Link `json:"ManagerForServers"`
	ManagerForSwitches  []dmtf.Link `json:"ManagerForSwitches"`
